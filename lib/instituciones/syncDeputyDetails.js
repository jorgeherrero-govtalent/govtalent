...
export async function diagnoseAgendaComunicacion() {
  ...
  const selectFieldName = 'ctl00$PlaceHolderMain$DisplayMode$agendaComunicacion$selectNivel3';
  ...
  // select y del botón — puede que use __doPostBack en vez de un submit
  // normal, o que el name= real sea distinto al que suponemos.
  const idxSelectTag = sectionHtml.indexOf('<select');

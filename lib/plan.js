...
export function planLabel(org) {
  ...
  // Los nombres comerciales son Free, Recruiter y Teams. En la base de
  // datos siguen siendo 'free', 'plus' y 'pro': renombrarlos ahí
  // obligaría a migrar filas y a revisar todas las comprobaciones de
  // permisos, y aquí es el único sitio donde se traducen.

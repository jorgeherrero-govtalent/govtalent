...
export async function proponer(texto, web = '') {
  const entrada = web
    ? `LO QUE ESCRIBE LA ORGANIZACIÓN:\n${texto}\n\nTEXTO DE SU WEB (para contexto; manda lo que escribe):\n${web}`
    : texto;
 ...
 */
export async function candidatos(supabase, keywords, { limite = MAX_CANDIDATOS } = {}) {
...
/** El texto visible de una web, para dárselo a la IA como contexto. */

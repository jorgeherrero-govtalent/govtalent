...
export function orgHasActivePlan(organization) {
  ...
  // Sin plan_status no se concede nada: antes un estado ausente contaba
  // como 'active', y las rutas que olvidaban pedir esa columna daban
  // acceso de pago a suscripciones canceladas (auditoría, punto 10).
  if (!SERVING_STATUSES.has(organization.plan_status)) return false;

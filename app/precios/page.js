...
async function getData() {
  ...
  const [{ data: authData }, { count: orgs }, { count: pros }] = await Promise.all([
...
export default async function PricingPage({ searchParams }) {
  const { loggedIn, orgsFundadoras, prosFundadores } = await getData();
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#f4f3ee' }}>
      ...
      <div className="pricing-wrap" style={{ flex: 1, maxWidth: 960, margin: '0 auto', width: '100%' }}>
        ...
        {paraOrgs ? (
          <>
            <BannerFundadores
              titulo="Founding Organizations — 199 €/año el primer año"
              detalle="Teams al 50 %, onboarding personalizado y participación en la evolución del producto. Después se renueva a 399 €/año."
          ...
          <>
            <BannerFundadores
              titulo="Precio Fundadores — 29 €/año el primer año"

...
export default function OrganosGobiernoPage() {
  ...
  const inactiva = { fontSize: 13, color: '#999', paddingBottom: 8, textDecoration: 'none' };
  ...
  return (
    <div className="sec" style={{ maxWidth: 1080 }}>
      ...
      <div style={{ display: 'flex', gap: 16, borderBottom: '.5px solid #e0dfd8', marginBottom: 14, flexWrap: 'wrap' }}>
        <Link href="/institutions/deputies" style={inactiva}>
          Diputados
        </Link>
        <Link href="/institutions/groups" style={inactiva}>
          Grupos parlamentarios
        </Link>
        <Link href="/institutions/comisiones" style={inactiva}>
          Comisiones
        </Link>
        <span
          style={{

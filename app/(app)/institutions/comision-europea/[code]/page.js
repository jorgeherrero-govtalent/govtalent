  ...
  if (dg === null) {
    return (
      <div className="sec" style={{ maxWidth: 860 }}>
        ...
        <BackLink fallbackHref="/institutions/comision-europea" fallbackLabel="Volver a la Comisión Europea" />
      </div>
    );
  }
  ...
  return (
    <div className="sec" style={{ maxWidth: 860 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12, flexWrap: 'wrap' }}>
        <BackLink fallbackHref="/institutions/comision-europea" fallbackLabel="Comisión Europea" />
        ...
        <span style={{ fontSize: 11.5, color: '#a8a49c' }}>
          ...
          {' › '}
          <Link href="/institutions/comision-europea" style={{ color: '#a8a49c', textDecoration: 'none' }}>
            Comisión Europea
          </Link>
          {' › '}
      ...
      {dg.comisario && (
        <div style={{ ...CARD, padding: 20, marginBottom: 12 }}>
          ...
          <Link
            href={`/institutions/comision-europea/comisarios/${dg.comisario_slug}`}

 ...
 */
function Institucion({ href, pais, titulo, descripcion, afectan, universo, etiquetaUniverso, pie, color = MORADO, mostrarBarra }) {
  // La barra solo si hay algo que enseñar. "0 te afectan" ocupa el sitio
  // de un dato sin serlo: no distingue entre "no hay nada tuyo ahí" y
  // "el análisis no cubre esa fuente".
  ...
  return (
    ...
    >
      ...
      {conBarra ? (
        ...
        <div style={{ marginTop: 18, paddingTop: 14, borderTop: '.5px solid #f2f0ec', display: 'flex', gap: 26, flexWrap: 'wrap' }}>
          <div>
          ...
          {/* Aquí solo va lo accionable. Los totales del tipo "3.802 en
              total" se han quitado: no cambian nada de lo que vayas a
              hacer y ocupan el sitio de algo que sí. */}
          {pie && (
            <div>
    ...
    <div className="sec" style={{ maxWidth: 1080 }}>
      ...
      <div className="reg-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14, marginTop: 22 }}>
        ...
        <Institucion
          ...
          mostrarBarra={hayAnalisis}
        />
        {/* El BOE no lleva barra: aquí ya no se influye, se cumple.
            Enseñar "cuántas te afectan" invitaría a una acción que ya no
            existe. */}
        <Institucion
          href="/boe"
          pais="es"

          ...
          <div style={{ ...CARD, padding: 20 }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 13, flexWrap: 'wrap' }}>
              <div style={{ flex: 1, minWidth: 200 }}>
                <div style={{ fontSize: 13.5, fontWeight: 500, letterSpacing: '-.1px' }}>
                  ¿Quieres que te avisemos de lo nuevo?
                </div>
                <div style={{ fontSize: 12, color: '#8b8780', lineHeight: 1.55, marginTop: 5 }}>
                  Guardamos estos criterios y revisamos cada día lo que se publica.
                </div>
              </div>
              <button
                type="button"

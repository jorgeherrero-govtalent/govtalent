...
export default function ProyectoDemo() {
  return (
    <div>
      ...
      {/* --- Briefing y agenda --- */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(290px, 1fr))', gap: 10, marginBottom: 10 }}>
      ...
      {/* --- Documentos y notas --- */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(290px, 1fr))', gap: 10, marginBottom: 12 }}>
        <div style={{ ...CARD, padding: '15px 18px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>

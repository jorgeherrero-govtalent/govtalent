...
export default function ClaimOrganizationModal({ organizationId, organizationName, userId, onClose, onSubmitted }) {
    ...
    >
      <div onClick={(e) => e.stopPropagation()} className="modal-box" style={{ maxWidth: 460, width: '100%', position: 'relative' }}>
        ...
        <div className="modal-head">
          <h2>Reclamar esta página</h2>
        </div>

        <div style={{ padding: '0 24px 24px' }}>
          <p style={{ fontSize: 12.5, color: '#888', marginBottom: 16, lineHeight: 1.5 }}>
            Para verificar que representas a <b>{organizationName}</b>, necesitamos un documento acreditativo (ej. CIF de la
            organización, escritura de constitución, o tarjeta de representante). Lo revisará el equipo de GovTalent antes de darte
            acceso — normalmente en menos de 48h.
          </p>

      ...
      <div className="lp">
        <div className="lp-col">
          ...
          <div className="bento" style={VENTANA}>
            <div style={{ display: 'flex', gap: 5, flexWrap: 'wrap', padding: '2px 2px 9px' }}>
            ...
            <div style={{ ...TARJETA, marginBottom: 7, display: 'flex', gap: 12, alignItems: 'flex-start' }}>
              <div style={{ flex: 1 }}>
          ...
          <div className="bento" style={VENTANA}>
            <div style={TARJETA}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 14 }}>
                <svg viewBox="0 0 42 42" width="62" height="62" style={{ flexShrink: 0 }}>
                ...
                <div>
                  <div style={{ fontSize: 13, fontWeight: 600, lineHeight: 1.35 }}>Tu encaje con el sector</div>
                  <div style={{ fontSize: 11, color: '#8b8780', marginTop: 3, lineHeight: 1.45 }}>
        ...
        <div className="lp-col lp-col-2">
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 13 }}>
              <i className="ti ti-sparkles" style={{ fontSize: 13, color: LILA }}></i>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 9, marginBottom: 14 }}>
              <i className="ti ti-loader-2 lp-gira" style={{ fontSize: 14, color: LILA }}></i>
              <span style={{ fontSize: 13, color: '#fff' }}>Buscando “inteligencia artificial”</span>
            </div>
  ...
  return (
    <div style={{ display: 'flex', gap: 11, alignItems: 'center' }}>
      {siglas ? (
        ...
        <span style={{ width: 34, height: 34, borderRadius: '50%', background: avatar, flexShrink: 0 }}></span>
      )}
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ fontSize: 12.5, fontWeight: 600, lineHeight: 1.3 }}>{titulo}</div>
        <div style={{ fontSize: 10.5, color: '#8b8780', marginTop: 2 }}>{sub}</div>
      </div>
